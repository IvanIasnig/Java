...
public class Main {
	public static void main(String[] args) {
		...
		for (int i = 0; i < 5; i++) {
			System.out.println("Inserisci il tipo di media (1 per Immagine, 2 per Audio, 3 per Video) per il media "
					+ (i + 1) + ":");
			...
			case 3:
				...
				break;
			default:
				System.out.println("Tipo di media non valido. Riprova inserendo un numero da 1 a 3.");
				i--;
				break;
			}
		}
